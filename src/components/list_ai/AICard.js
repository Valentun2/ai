const Card = ({ title, img, view, tag, arr, children }) => {
  return (
    arr?.includes(title.toLowerCase()) && (
      <li className="group w-[358px] md:w-[344px] lg:w-[288px] xl:w-[284px] 2xl:w-[404px] max-h-[303px] bg-cardsTransparent box-border border-[1px] border-cardsBorder flex flex-col  justify-between p-4 rounded-2xl hover:bg-cardsHover transition-all duration-500 relative">
